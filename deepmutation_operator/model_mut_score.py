...
class ModelMutateScore:
    ...
    def __init__(self):
        ...
        self.generated_dataset = self.network.load_generated_data()
    ...
    def integration_test(self):
        ...
        modes = ['GF', 'WS', 'NEB', 'NS', 'LD', 'LAm', 'AFRm']
        ...
        train_data, train_label = self.train_dataset
        test_data, test_label = self.test_dataset
        generated_data, generated_label = self.generated_dataset
        ...
        self.generated_dataset = (generated_data, generated_label)
        ...
        for index, mode in enumerate(modes):
            ...
            # train data
            num_mutant_killed_class, _ = self.cal_mutate_score_by_model_mutation(self.train_dataset, model, mode)
            num_mutant_killed_classes_of_train += num_mutant_killed_class

            # test data
            num_mutant_killed_class, num_mutant_error_rate = self.cal_mutate_score_by_model_mutation(self.test_dataset,
                                                                                                      model, mode)
            num_mutant_killed_classes_of_test += num_mutant_killed_class

            # generated data
            num_mutant_killed_class, _ = self.cal_mutate_score_by_model_mutation(self.generated_dataset, model, mode)
    ...
    def cal_mutate_score_by_model_mutation(self, test_dataset, model, mode):
